            ...
            <div class="card card-shadcn">
                <div class="card-body">
                    <div class="text-center mb-4">
                        <div class="icon icon-shape bg-danger bg-opacity-10 text-danger rounded-circle mx-auto mb-3" style="width: 80px; height: 80px;">
                            <i class="fas fa-minus fa-2x"></i>
                        </div>
                        <h5 class="card-title mb-2">Add New Expense</h5>
                        <p class="text-muted">Record your expense details to track your spending</p>
                    </div>
