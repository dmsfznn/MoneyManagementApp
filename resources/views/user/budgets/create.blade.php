                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('user.budgets.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    @enderror
                                    <div class="form-text">Enter the maximum amount you want to spend for this budget.</div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror"
                                              ...
                                              name="notes"
                                              rows="3"
                                              placeholder="Add any additional notes about this budget...">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateMonthYearInput() {
        ...
        if (selectedPeriod === 'yearly') {
            ...
            monthYearInput.value = new Date().getFullYear();
            ...
            monthYearInput.value = new Date().toISOString().slice(0, 7);
